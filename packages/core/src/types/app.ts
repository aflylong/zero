export type DeliveryMode = "in-app" | "wechat-subscribe" | "system-notification";
...
export interface VisionProfile {
  ...
  /** 一年目标 — 原文称"主线任务(mission)",人生当前阶段唯一的优先事项 */
  yearGoal: string;
  yearGoalDescription: string;

  /** 一月项目 — 原文称"Boss 战",当前要攻克的具体里程碑 */
  monthProject: string;
  ...
  /** @deprecated 向后兼容,运行时映射到 yearGoal */
  mainQuestTitle: string;
  /** @deprecated 向后兼容,运行时映射到 yearGoalDescription */
